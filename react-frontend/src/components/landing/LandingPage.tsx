    ...
    <div className="flex min-h-[100dvh] flex-col bg-background text-foreground">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2">
              <Link
                to="/login"
                className="block rounded-md px-3 py-2 text-base font-medium text-muted-foreground hover:bg-gray-800 hover:text-foreground"
        ...
        <section className="w-full py-12 md:py-24 relative overflow-hidden">
          ...
          >
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-4 md:gap-8">
              {/* Black Card */}
              <div className="relative h-64 w-48 rounded-lg bg-background p-4 shadow-lg transform rotate-[-5deg]">
              ...
              {/* White Cards */}
              <div className="relative h-64 w-48 rounded-lg bg-background p-4 shadow-lg text-foreground transform rotate-[3deg]">
              ...
              <div className="relative h-64 w-48 rounded-lg bg-background p-4 shadow-lg text-foreground transform rotate-[8deg] hidden sm:block">
                <p className="font-medium">
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32">
          ...
          >
            ...
            >
              ...
              <Card className="bg-background border-border shadow-xl sm:col-span-2 md:col-span-1">
                <div className="flex flex-col items-center p-6 text-center">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/20 text-primary">
          ...
          >
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-foreground text-background font-bold text-xl">
                  1
                </div>
                <h3 className="mt-4 text-xl font-bold">Login</h3>
                <p className="mt-2 text-muted-foreground">
                  Sign in with a OAuth provider to access the game.
                </p>
              </div>
      ...
      <footer className="w-full border-t border-border bg-background py-12">
        ...
        >
          ...
          {/* <div className="flex flex-col items-center justify-between gap-4 border-t border-border py-6 md:h-24 md:flex-row md:py-0 mt-8"> */}
